...
function adicionar (){
    noNum= 10;
    return"O valor da variável agora é "+ noNum
}
...
function newFunc(arg1, arg2, arg3){
...
//Texto de tratativa de erro

// Agora invoque novamente a função criada acima, mas passando todos os três argumentos necessários.
// Qual o resultado da invocação acima? (Use comentários para mostrar o valor retornado).
console.log(newFunc(1,2,5))
...
console.log(testArgs(10)); 
console.log(testArgs(10,10));
console.log(testArgs(10,10,10));
